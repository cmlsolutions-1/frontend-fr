export async function getPaginatedMockProductsWithImages({ page = 1, gender }: { page: number, gender?: string }) {
  const allProducts = [
    {
      id: '00526',
    ...
    {
      id: '11236',
      title: 'CONTROLADOR ELECTRONICO DE PRESION P/BOMBA AQUA PLUS 110V-240V EPS-01',
      slug: 'controlador-electronico',
      description: 'CONTROLADOR ELECTRONICO DE PRESION P/BOMBA AQUA PLUS 110V-240V EPS-01',
      price: 105000,
      inStock: 5,
    ...
    {
      id: '12466',
      title: 'HERRAJE GAVINETE  SOFA CAMA CABECERO CLIP  10 CM (PAR) NEGRO                    ',
      slug: 'herraje-gavinete',
      description: 'HERRAJE GAVINETE  SOFA CAMA CABECERO CLIP  10 CM (PAR) NEGRO',
      price: 5700,
      inStock: 5,
    ...
    },
    {
      ...
      slug: 'herraje-gavinete',
      description: 'HERRAJE GAVINETE  SOFA CAMA CABECERO CLIP 10 CM (PAR) BLANCO',
      price: 5800,
      inStock: 5,
    ...
    {
      id: '12654',
      title: 'ESCALERA METALICA  80 CM X 2 PELDAÑOS ARTICULADA NARANJA 150K  MAX 30*20 CM PASO',
      slug: 'escalera-articulada-2',
      description: 'ESCALERA METALICA  80 CM X 2 PELDAÑOS ARTICULADA NARANJA 150K  MAX 30*20 CM PASO',
      price: 97800,
      inStock: 5,
    ...
    {
      id: '12655',
      title: 'ESCALERA METALICA 103 CM X 3 PELDAÑOS ARTICULADA NARANJA 150K MAX 30*20CM  PASO',
      slug: 'escalera-articulada-3',
      description: 'ESCALERA METALICA 103 CM X 3 PELDAÑOS ARTICULADA NARANJA 150K MAX 30*20CM  PASO',
      price: 5800,
      inStock: 5,
